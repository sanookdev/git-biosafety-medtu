...
<head>
    ...
    <title>reports Awaiting for approve</title>
...
<body>
                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                <h3 class=" card-title mr-auto p-1">โครงการใหม่รออนุมัติ</h3>
                        ...
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="reportAwaitingApprove_table"
    ...
    $(document).ready(function() {
        var table = $('#reportAwaitingApprove_table').DataTable({
            lengthChange: false,
            buttons: ['excel']
        });
        table.buttons().container()
            .appendTo('#reportAwaitingApprove_table_wrapper .col-md-6:eq(0)');
    });
    </script>
</body>
